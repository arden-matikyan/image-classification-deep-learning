...
# normalization + relu + affine fwd 
def bn_affine_relu_forward(x, w, b, gamma, beta, bn_param, dropout_param, last=False):
    ...
    if not last:
        # if there us normalizaiton, batch or layer 
...
# normalization + relu + affine bckward 
